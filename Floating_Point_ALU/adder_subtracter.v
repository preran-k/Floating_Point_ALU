...
module adder_32bit(
    ...
    compare_shift campare_shift(.exp_a(exp_a),.exp_b(exp_b),
    .man_a(man_a),.man_b(man_b),
    .al_man_a(al_man_a),
    .al_man_b(al_man_b),
    .shift(shift));
    
    addition addition(.sign_a(sign_a),.sign_b(sign_b),
    .al_man_a(al_man_a),.al_man_b(al_man_b),
    .res(res),
    .sign_res(sign_res));
    
    normalization normalization(.res(res),
